...
export default function ProfessionalTimeline({
  ...
  const getSortedRoles = () => {
    ...
    if (mode === "data-analyst") {
      ...
      const dataAnalystRoles = rolesCopy.filter(role => getRoleMode(role) === "data-analyst");
      const processMiningRoles = rolesCopy.filter(role => getRoleMode(role) === "process-mining");
